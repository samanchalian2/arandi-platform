...
1. Obtain stakeholder visual acceptance for the live Scrollwise footer/Taupe release `20260825T123724Z-scrollwise-footer`, then observe GitHub CI for commit `cf4cd8e`. Preserve the current release and the retained rollback releases until acceptance.
