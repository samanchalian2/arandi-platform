...
1. Obtain stakeholder visual acceptance for the live Scrollwise release `20260826T-scrollwise-header-controls` at canonical `https://arandi.io` (including the Admin-governed 48px/16px header defaults and exact `#EDE9E1` footer), then observe GitHub CI for commits `e8a54c1`, `d8187cc`, `cc8b724`, and `8fe17fb`. Preserve the active release and immediate rollback release on `arandivps`.
