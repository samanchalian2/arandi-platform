...
1. Obtain stakeholder visual acceptance for the live Scrollwise release `20260827T-scrollwise-footer-edeae7` at canonical `https://arandi.io` (including the Admin-governed 48px/16px header defaults and exact `#EDEAE7` footer), then observe GitHub CI for commits `e8a54c1`, `d8187cc`, `cc8b724`, `8fe17fb`, and `190165a`. Preserve the active release and immediate rollback release on `arandivps`.
