...
1. Obtain stakeholder visual acceptance for the live Scrollwise release `20260827T-scrollwise-cache-refresh` at canonical `https://arandi.io` (including the Admin-governed 48px/16px header defaults, light internal-page palette, and exact `#EDEAE7` footer), then observe GitHub CI for commits `e8a54c1`, `d8187cc`, `cc8b724`, `8fe17fb`, `190165a`, `a52267c`, and `c7ef375`. Preserve the active release and immediate rollback release on `arandivps`.
