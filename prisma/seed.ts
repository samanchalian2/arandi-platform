...
async function seedMediaAndSettings() {
    ...
    const settings = [
        ...
        },
        {
            ...
            value: { motionPreset: "cinematic", showMotionControl: false, menuMode: "narrative", headerLogoSize: 64, headerTitleSize: 28, headingScale: 100, veilOpacity: 0.94, storyHeight: 150, interludeHeight: 90 },
            group: "theme",
            isPublic: false,
        },
