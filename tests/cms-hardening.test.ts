...
test("Scrollwise experience settings are bounded and reject arbitrary fields", () => {
    const value = { motionPreset: "cinematic", showMotionControl: false, menuMode: "narrative", headerLogoSize: 48, headerTitleSize: 16, headingScale: 100, veilOpacity: 0.94, storyHeight: 150, interludeHeight: 90 };
    ...
    assert.throws(
        () => parsePublicSettingValue("site.scrollwiseExperience", { ...value, headerLogoSize: 65 }),
